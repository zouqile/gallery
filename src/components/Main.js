...
//你用自执行函数，将图片信息转为url信息
imageDatas = (function (dataArray) {
...
var AppComponent = React.createClass({
  ...
  /**
   * 翻转图片
   * @param index 输入当前被执行inverse操作的图片对应的图片信息数组index值
   ...
   * @param index，需要被居中的图片对应的图片信息的index值
   * @return {functon}
   */
    ...
    return {
      imgsArrangeArr: [
        /* {
            ...
            rotate:0,//旋转角度
            isInverse:false,//图片正反面（false怎么，true反面）
